...
/**
	...
	@type	Object
	@name	JUL.Designer.framework.ui
*/
jul.ns('JUL.Designer.framework.ui', {
	tag: 'dialog',
	id: 'dialog-framework',
	title: 'Framework',
	width: 980,
...
/**
	...
	@type	Object
	@name	JUL.Designer.framework.logic
*/
jul.ns('JUL.Designer.framework.logic', {
...
jul.apply(jul.get('JUL.Designer.framework'), /** @lends JUL.Designer.framework */ {
	/**
	...
	*/
	...
	augment: function(sResponse) {
		...
		if (!oFramework.current.augments || oFramework.state.parents.length > oFramework.augmentLevel ||
			oFramework.state.parents.indexOf(oFramework.current.augments) > -1 || (sResponse && !oResult)) {
