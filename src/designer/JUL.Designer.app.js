...
/**
	...
	@type	Object
	@name	JUL.Designer.app.ui
*/
jul.ns('JUL.Designer.app.ui', {
	tag: 'dialog',
	id: 'dialog-app',
	title: 'Application',
	width: 980,
...
/**
	...
	@type	Object
	@name	JUL.Designer.app.logic
*/
jul.ns('JUL.Designer.app.logic', {
	'button-add-module': {
		listeners: {
			command: function() {
...
jul.apply(jul.get('JUL.Designer.app'), /** @lends JUL.Designer.app */ {
	/**
	...
	*/
	show: function(sOperation) {
		...
		if (sOperation === 'new' && JUL.Designer.framework.current.ns) {
			oCurrent.preferredFramework = JUL.Designer.framework.current.ns;
		}
	...
	*/
	testJs: function(oJs, bComment) {
		...
		return JUL.Designer.wrapExport(sJs, bComment, 'oApp');
	},
	/**
